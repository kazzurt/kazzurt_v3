...
class tics:
    ...
    def tic2(y):
        global p, qq, a, ar, colm, qq2, thresh, color, colm2, cl, nu, fwd, hg, tic_yn, cnt
        ...
        colm = np.linspace(0,config.N_PIXELS // 2-1, nu).astype(int)
        if qq2>40:
            color = pallette.pal(0)
            qq2 = 0
           
        if ty>thresh or qq>5:
    ...
    def ticpal(y):
        ...
        if ty>thresh or qq>15 : #Right arrow
