...
functs = ["colorwave01","colorwave02","colorwave4","colorwave6","colorwave7","bessel1","bessel2", "pointwave", \
          "colorwave8","colorwave9","heart1","heart1","heart1",\
          "sweetscroll","scroll4","ddr3","ddr3","ddr3","ddr2","colorwave1",\
          "smiley","newt","newt2", "dantewave","dantewave2"]  
...
#         but1 = 0
    ...
    if ct >= t11 and ct < t12:       #first half of linger
        ...
        if FF != "umbrella" and FF != "umbrella_dark" and FF != "fract1" and FF != "ddr3" and FF != "poop" and FF != "pot" \
           and FF != "insta" and FF != "heart1" and FF != "smiley":
            if FF2 != "umbrella" and FF2 != "umbrella_dark" and FF2 != "fract1" and FF2 != "ddr3" and FF2 != "poop" and FF2 != "pot" \
        ...
        t14 += ni
        t15 += ni
        print('=========================================New Function: ', functs[funs[ft]])
...
def visualize_ddr2(y):
    ...
    return p
def visualize_ddr3(y):
    p = ddr3.ddr3(y,umb_init)
    return p
...
elif sys.argv[1] == 'ddr3':
        visualization_type = visualize_ddr3
