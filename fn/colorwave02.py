...
class colorwave02:
    ...
    def colorwave02(y):
            ...
            for i in arx:
                ...
                gre_ar[i,ary] =  (.5*np.sin(rtim11/div2 + ary/yf + i/xf + ph1*np.pi/3)+.5)*255
                blu_ar[i,ary] =  (.5*np.sin(rtim11/div3 + ary/yf + i/xf + ph2*np.pi/3)+.5)*255
            
#             n = 5
#             blu_ar = rotatee(blu_ar, rtim31/5, n)
#             gre_ar = rotatee(gre_ar, rtim31/5, n)
#             red_ar = rotatee(red_ar, rtim31/5, n)
